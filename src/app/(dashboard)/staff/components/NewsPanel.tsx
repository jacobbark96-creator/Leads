    ...
    <GlassCard delay={0.3} className="p-4 flex flex-col h-full">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-xs font-medium text-blue-400 cursor-pointer hover:text-blue-300 transition-colors">View all</span>
        </div>
      </div>
      ...
      {news.length === 0 ? (
        <div className="flex-1 flex flex-col items-center justify-center text-center">
          ...
          <p className="text-sm text-gray-400 font-medium">No company news</p>
          {profile?.role === 'super_admin' && (
            <button 
              onClick={() => setIsModalOpen(true)}
              className="text-[11px] text-blue-400 mt-1 hover:underline"
            >
