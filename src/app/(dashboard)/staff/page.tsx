    ...
    <div className="p-8 max-w-7xl mx-auto min-h-[80vh] flex flex-col justify-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        {(profile.role === 'admin' || profile.role === 'super_admin' || profile.role === 'sales') && (
          <Link href="/sales-crm" className="bg-white p-8 rounded-3xl shadow-sm border border-gray-200 hover:shadow-xl hover:border-blue-300 hover:-translate-y-1 transition-all flex flex-col items-center justify-center gap-6 text-center group">
        ...
        {(profile.role === 'admin' || profile.role === 'super_admin' || profile.role === 'sales') && (
          <Link href="/contractor-crm" className="bg-white p-8 rounded-3xl shadow-sm border border-gray-200 hover:shadow-xl hover:border-amber-300 hover:-translate-y-1 transition-all flex flex-col items-center justify-center gap-6 text-center group">
        ...
        {(profile.role === 'admin' || profile.role === 'super_admin') && (
          <Link href="/admin-crm" className="bg-white p-8 rounded-3xl shadow-sm border border-gray-200 hover:shadow-xl hover:border-purple-300 hover:-translate-y-1 transition-all flex flex-col items-center justify-center gap-6 text-center group">
        ...
        <Link href="/intranet" className="bg-white p-8 rounded-3xl shadow-sm border border-gray-200 hover:shadow-xl hover:border-emerald-300 hover:-translate-y-1 transition-all flex flex-col items-center justify-center gap-6 text-center group">
