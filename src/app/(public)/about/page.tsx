        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="lg:w-1/2">
            ...
            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
              At Kairo Leads, we understand that your time is best spent closing deals and serving customers—not hunting for prospects. Founded by industry veterans, our platform was built to solve the biggest bottleneck in contracting businesses: predictable revenue.
            </p>
