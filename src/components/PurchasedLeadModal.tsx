        ...
        <div className="flex-1 overflow-y-auto p-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-blue-50 p-5 rounded-xl border border-blue-100 shadow-sm space-y-4">
                ...
                {lead.phone && (
                  <div className="flex items-center pb-3 border-b border-blue-200/50">
                    ...
                    <a href={`tel:${lead.phone}`} className="font-medium text-blue-600 hover:underline">{lead.phone}</a>
                  </div>
                )}
                ...
                <div className="flex items-start">
                  ...
                  <span className="font-medium text-gray-900 leading-tight">{lead.location || 'No address provided'}</span>
                </div>
              </div>
              ...
              <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm space-y-4">
                ...
                <div className="flex items-center justify-between pb-3 border-b border-gray-100">
                  ...
                  <span className="font-bold text-green-600 text-lg">£{lead.monthly_spend ? Number(lead.monthly_spend).toLocaleString() : 'N/A'}/mo</span>
                </div>
            ...
            <div className="space-y-8">
              ...
              <div>
                <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wider mb-4 flex items-center gap-2">
                  <Info className="w-4 h-4 text-gray-400" /> Qualification Notes
                </h3>
                <div className="bg-gray-50 p-5 rounded-xl text-sm leading-relaxed border border-gray-200">
