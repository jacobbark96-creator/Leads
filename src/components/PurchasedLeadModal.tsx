                  ...
                  <div className="grid grid-cols-2 gap-2 flex-1">
                      ...
                      <div className="bg-gray-50 rounded-lg p-2 flex justify-between divide-x divide-gray-200">
                          ...
                          <div className="flex flex-col justify-center pl-2 w-1/2">
                            <span className="text-[10px] text-gray-400 uppercase tracking-wider font-bold mb-1 flex items-center gap-1.5"><LayoutGrid className="w-3 h-3" /> Roof Size (SqM)</span>
                            <DisplayValue 
