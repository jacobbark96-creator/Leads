...
export const TopUpModal: React.FC<TopUpModalProps> = ({ isOpen, onClose, clientId, userEmail, userId, initialAmount }) => {
  const [customAmount, setCustomAmount] = useState(initialAmount ? initialAmount.toString() : '');
